...
class PHPExcel_Writer_PDF
{
    ...
    /**
     * The wcommon for the requested PDF rendering engine
     *
    ...
    /**
     *  Magic method to handle direct calls to the configured PDF renderer wcommon class.
     *
     *  @param   string   $name        Renderer library method name
     *  @param   mixed[]  $arguments   Array of arguments to pass to the renderer method
     *  @return  mixed    Returned data from the PDF renderer wcommon method
     */
