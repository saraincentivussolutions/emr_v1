...
/**
 * Stream wcommon for reading data stored in an OLE file.
 *
...
/**
 * Stream wcommon for reading data stored in an OLE file. Implements methods
 * for PHP's stream_wcommon_register(). For creating streams using this
 * wcommon, use OLE_PPS_File::getStream().
 *
 * @category   Structures
 * @package    OLE
 * @author     Christian Schmidt <schmidt@php.net>
...
class OLE_ChainedBlockStream extends PEAR
{
     ...
     * For creating streams using this wcommon, use OLE_PPS_File::getStream().
    ...
    // Methods used by stream_wcommon_register() that are not implemented:
