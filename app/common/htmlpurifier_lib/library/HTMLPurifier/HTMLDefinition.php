...
class HTMLPurifier_HTMLDefinition extends HTMLPurifier_Definition
{
    ...
    protected function setupConfigStuff($config) {
        ...
        $block_wcommon = $config->get('HTML.BlockWcommon');
        if (isset($this->info_content_sets['Block'][$block_wcommon])) {
            $this->info_block_wcommon = $block_wcommon;
        } else {
            trigger_error('Cannot use non-block element as block wcommon',
                E_USER_ERROR);
        }
