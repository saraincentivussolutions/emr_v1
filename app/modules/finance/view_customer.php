    ...
    <section class="content-header">
      <h1> Finance Entry
        <div class="col-md-4 no-padding text-right pull-right">
          <button class="btn btn-primary btn-sm"  onclick="CreateUpdateCustomerFinanceListMasterSave()" style="margin-right:10px;" type="button"  id="savefinance" ><i class="fa fa-floppy-o"></i> Submit</button>
      ...
      <div class="box-body white-bg">
		...
		<ul class="tabs">
         ...
         <!-- <div class="col-md-2 ">
          ...
          <fieldset>
          <div class="col-md-2 ">
             <label>First followup date</label>
            <div class="input-group date" style="width:150px;" onclick="funcCallDate(this);">
              <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
              <input type="text" name="first_followup_date" id="first_followup_date"  class="form-control pull-right datepicker clsAlwaysShw" maxlength="10" >
            </div>
          </div>
          <div class="col-md-3">
            <label>Notes</label>
          ...
          <div class="col-md-2">
            <label>Next followp date </label>
            <div class="input-group date" style="width:150px;" onclick="funcCallDate(this);">
              <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
              <input type="text" name="next_followup_date1" id="next_followup_date1"  class="form-control pull-right datepicker clsAlwaysShw" maxlength="10" >
            </div>
          </div> 
          ...
          <fieldset>
          <div class="col-md-2 ">
            <label>Second followup date </label>
            <div class="input-group date" style="width:150px;" onclick="funcCallDate(this);">
              <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
              <input type="text" name="second_followup_date" id="second_followup_date"  class="form-control pull-right datepicker clsAlwaysShw" maxlength="10" >
            </div>
          </div>
          <div class="col-md-3">
            <label>Notes</label>
          ...
          <div class="col-md-2">
            ...
            <div class="input-group date" style="width:150px;" onclick="funcCallDate(this);">
              <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
              <input type="text" name="next_followup_date2" id="next_followup_date2"  class="form-control pull-right datepicker clsAlwaysShw" maxlength="10" >
            </div>
            </div>
          </div>
          </fieldset>
          ...
          <div class="col-md-2">
            ...
            <div class="input-group date" style="width:150px;" onclick="funcCallDate(this);">
              <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
              <input type="text" name="third_followup_date" id="third_followup_date"  class="form-control pull-right datepicker clsAlwaysShw" maxlength="10" >
            </div>
          </div>
          <div class="col-md-3">
            <label>Notes</label>
          ...
          <label>Next followp date </label>
            <div class="input-group date" style="width:150px;" onclick="funcCallDate(this);">
              <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
              <input type="text" name="next_followup_date3" id="next_followup_date3"  class="form-control pull-right datepicker clsAlwaysShw" maxlength="10" >
            </div>
            </div>
          ...
          <fieldset>
          <div class="col-md-2">
            <label>Fourth followup date</label>
            <div class="input-group date" style="width:150px;" onclick="funcCallDate(this);">
              <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
              <input type="text" name="fourth_followup_date" id="fourth_followup_date"  class="form-control pull-right datepicker clsAlwaysShw" maxlength="10" >
            </div>
          </div> 
          <div class="col-md-3">
            <label>Notes</label>
          ...
          <div class="col-md-4">
            ...
            <div class="col-md-6 no-padding">
              <label class="lblText">
              <input type="radio" id="do_approved1" name="do_approved" value="1" onclick="showReceiptAddOpt()" class="clsAlwaysShw" > 
              Yes </label>
               	  
                   <button class="btn btn-primary btn-sm"  onclick="addReceiptFromFinance()" style="margin-right:10px;" type="button" id="addrcptbtn"><i class="fa fa-plus"></i> Add Receipt</button>		   	  <input name="entry_date" type="hidden" maxlength="20" id="entry_date" class="" />
                   <input name="entry_by" type="hidden" maxlength="50" id="entry_by" class="">
                    <input name="receipt_date" type="hidden" maxlength="20" id="receipt_date" class="" />
                    <input id="payment_mode" type="hidden" name="payment_mode" checked="checked" value="1">
                    <input id="chque_dd_type" type="hidden" name="chque_dd_type" checked="checked" value="0"> 
                    <input name="bank_name" type="hidden"   id="bank_name" class=""   maxlength="50">
                    <input name="cheque_no" type="hidden"   id="cheque_no" class=""   maxlength="20">
                    <input name="receipt_remarks" type="hidden" maxlength="150" id="receipt_remarks" >
                    <input type="hidden" name="hdn_receipt_chk" id="hdn_receipt_chk" value="0" />
                    <input type="hidden" name="receipt_amount" id="receipt_amount" value="0" />
            </div>
            
            <div class="col-md-6 no-padding">
              <label class="lblText">
              <input type="radio" id="do_approved2" name="do_approved" value="2"  onclick="showReceiptAddOpt()" class="clsAlwaysShw" >
              No </label>
            </div>
          </div>
