 <div class="content-wcommon">
         <section class="content-header">
          <h1>
             User Role
			  ...
			  <a class="js-open-modal btn btn-success" href="#" data-modal-id="popup1" onclick="CreateUpdateUserRoleMasterList();"><i class="fa fa-plus"></i> Create New</a>
			</div>		  	 
		</h1>	
		<di
        </section>
        ...
        <section class="content">
		  ...
		  <div class="alert alert-success alertSuccDivMsg"   >
                  ...
                  <table class="table table-bordered table-striped" id="user_roleMasterTbl">
                    <thead>
                      <tr>
                        <th width="10%">S.No</th>
  ...
  <div class="modal " id="viewDeleteModal" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-primary" id="btnModalDelete" onclick="deleteUserRoleMaster()"  data-dismiss="modal"><i class="fa fa-floppy-o"></i>&nbsp; Yes</button>
