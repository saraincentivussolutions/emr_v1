        ...
        <section class="content"> 	
          <div class="box-body white-bg">
			...
			<ul class="tabs"> 
				...
				<li class="tab-link" data-tab="tab-6">Approval</li>
			</ul>
			...
			<div id="tab-1" class="tab-content current">
				...
				<fieldset>
					...
					<div class="col-sm-2">
						<input name="cosumer_offer_srt_addition" type="text"   id="cosumer_offer_srt_addition" class="form-control" value="<?php echo $rsData['cosumer_offer_srt_addition']; ?>" onkeypress="return ValidateNumberKeyPress(this, event);" maxlength="10" onkeyup="bkcalOfferPriceTotal()"  />
					</div>
				</fieldset>
				<fieldset>
					<div class="col-sm-4">
					...
					<div class="col-sm-2">
						<input name="corporate_offer_srt_addition" type="text"  id="corporate_offer_srt_addition" class="form-control"  value="<?php echo $rsData['corporate_offer_srt_addition']; ?>" onkeypress="return ValidateNumberKeyPress(this, event);" maxlength="10" onkeyup="bkcalOfferPriceTotal()"   />
					</div>
				</fieldset>
				<fieldset class="clsBkExchange">
					<div class="col-sm-4">
					...
					<div class="col-sm-2">
						<input name="exchange_offer_srt_addition" type="text"  id="exchange_offer_srt_addition" class="form-control"  value="<?php echo $rsData['exchange_offer_srt_addition']; ?>" onkeypress="return ValidateNumberKeyPress(this, event);" maxlength="10" onkeyup="bkcalOfferPriceTotal()"  />
					</div>
				</fieldset>
				<fieldset>
					<div class="col-sm-4">
					...
					<div class="col-sm-2">
						<input name="access_offer" type="text"  id="access_offer" class="form-control"  value="<?php echo $rsData['access_offer']; ?>"  onkeypress="return ValidateNumberKeyPress(this, event);" maxlength="10" onkeyup="bkcalOfferPriceTotal()"  />
					</div>
					<div class="col-sm-2">
						<input name="access_offer_srt" type="text"  id="access_offer_srt" class="form-control"  value="<?php echo $rsData['access_offer_srt']; ?>"  onkeypress="return ValidateNumberKeyPress(this, event);" maxlength="10" onkeyup="bkcalOfferPriceTotal()"  />
					</div>
					<div class="col-sm-2">
						<input name="access_offer_srt_addition" type="text"  id="access_offer_srt_addition" class="form-control"  value="<?php echo $rsData['access_offer_srt_addition']; ?>"  onkeypress="return ValidateNumberKeyPress(this, event);" maxlength="10" onkeyup="bkcalOfferPriceTotal()"  />
					</div>
				</fieldset>
				<fieldset>
					<div class="col-sm-4">
					...
					<div class="col-sm-2">
						<input name="insurance_offer" type="text"  id="insurance_offer" class="form-control"  value="<?php echo $rsData['insurance_offer']; ?>"  onkeypress="return ValidateNumberKeyPress(this, event);" maxlength="10" onkeyup="bkcalOfferPriceTotal()"  />
					</div>
					<div class="col-sm-2">
						<input name="insurance_offer_srt" type="text"  id="insurance_offer_srt" class="form-control"  value="<?php echo $rsData['insurance_offer_srt']; ?>"  onkeypress="return ValidateNumberKeyPress(this, event);" onkeyup="bkcalOfferPriceTotal()" maxlength="10"  />
					</div>
					<div class="col-sm-2">
						<input name="insurance_offer_srt_addition" type="text"  id="insurance_offer_srt_addition" class="form-control"  value="<?php echo $rsData['insurance_offer_srt_addition']; ?>"  onkeypress="return ValidateNumberKeyPress(this, event);" onkeyup="bkcalOfferPriceTotal()" maxlength="10"  />
					</div>
				</fieldset>
				<fieldset>
					<div class="col-sm-4">
					...
					<div class="col-sm-2">
						<input name="add_discount" type="text"  id="add_discount" class="form-control"  value="<?php echo $rsData['add_discount']; ?>"  onkeypress="return ValidateNumberKeyPress(this, event);" maxlength="10" onkeyup="bkcalOfferPriceTotal()"  />
					</div>
					<div class="col-sm-2">
						<input name="add_discount_srt" type="text"  id="add_discount_srt" class="form-control"  value="<?php echo $rsData['add_discount_srt']; ?>"  onkeypress="return ValidateNumberKeyPress(this, event);" maxlength="10" onkeyup="bkcalOfferPriceTotal()"  />
					</div>
					<div class="col-sm-2">
						<input name="add_discount_srt_addition" type="text"  id="add_discount_srt_addition" class="form-control"  value="<?php echo $rsData['add_discount_srt_addition']; ?>"  onkeypress="return ValidateNumberKeyPress(this, event);" maxlength="10" onkeyup="bkcalOfferPriceTotal()"  />
					</div>
				</fieldset>
				<fieldset>
					<div class="col-sm-4">
					...
					<div class="col-sm-2">
						<input name="edr" type="text"   id="edr" class="form-control"  value="<?php echo $rsData['edr']; ?>"  onkeypress="return ValidateNumberKeyPress(this, event);" maxlength="10"  onkeyup="bkcalOfferPriceTotal()"  />
					</div>
					<div class="col-sm-2">
						<input name="edr_srt" type="text"  id="edr_srt" class="form-control"  value="<?php echo $rsData['edr_srt']; ?>"  onkeypress="return ValidateNumberKeyPress(this, event);" maxlength="10"  onkeyup="bkcalOfferPriceTotal()"  />
					</div>
					<div class="col-sm-2">
						<input name="edr_srt_addition" type="text"  id="edr_srt_addition" class="form-control"  value="<?php echo $rsData['edr_srt_addition']; ?>"  onkeypress="return ValidateNumberKeyPress(this, event);" maxlength="10"  onkeyup="bkcalOfferPriceTotal()"  />
					</div>
				</fieldset>
				<fieldset>
					<div class="col-sm-4">
						<input name="other_offer_desc" type="text" maxlength="50" id="other_offer_desc" class="form-control" placeholder="Others"  value="<?php echo $rsData['other_offer_desc']; ?>"  onkeyup="bkcalOfferPriceTotal()" />
					</div>
					<div class="col-sm-2">
						<input name="other_contribution" type="text"   id="other_contribution" class="form-control"  value="<?php echo $rsData['other_contribution']; ?>"   onkeypress="return ValidateNumberKeyPress(this, event);" maxlength="10"  onkeyup="bkcalOfferPriceTotal()"  />
					</div>
					<div class="col-sm-2">
						<input name="other_contribution_srt" type="text"   id="other_contribution_srt" class="form-control" value="<?php echo $rsData['other_contribution_srt']; ?>"  onkeypress="return ValidateNumberKeyPress(this, event);" maxlength="10"  onkeyup="bkcalOfferPriceTotal()" />
					</div>
					<div class="col-sm-2">
						<input name="other_contribution_srt_addition" type="text"   id="other_contribution_srt_addition" class="form-control" value="<?php echo $rsData['other_contribution_srt_addition']; ?>"  onkeypress="return ValidateNumberKeyPress(this, event);" maxlength="10"  onkeyup="bkcalOfferPriceTotal()" />
					</div>
				</fieldset>
				<fieldset>
					<div class="col-sm-4">
				...
				<div id="tab-5" class="tab-content">
                 ...
                 <div id="tab-6" class="tab-content">
                                ...
                                <fieldset>
                                    ...
                                    <div class="col-sm-4 pull-left no-padding">
                                        <input name="approved_by" type="text" maxlength="50" id="approved_by" class="form-control clsAlwaysShw" placeholder="Approved By" value="<?php echo $rsData['approved_by']; ?>"/>
                                    </div>
                                    <div class="col-sm-2 pull-left">
									...
									<div class="col-sm-4 pull-left no-padding">
									<div class="input-group date" style="width:150px;" onclick="funcCallDate(this);"><div class="input-group-addon"><i class="fa fa-calendar"></i></div>
										<input name="approved_date" type="text" maxlength="20" id="approved_date" class="form-control pull-right datepicker clsAlwaysShw" placeholder="Approved Date" value="<?php echo $rsData['approved_date']; ?>"/></div>
									</div>
                                </fieldset>
                                <fieldset>
								<div class="col-sm-2 pull-left">
                                    ...
                                    <div class="col-sm-2 no-padding">
										<div class="col-sm-6 no-padding">
                                        	<label class="lblText"><input id="retail_status1" type="radio" name="retail_status" value="1" <?php echo ($rsData['retail_status']==1)?'checked':''; ?> class="clsAlwaysShw" /> Yes</label>
										</div>
										<div class="col-sm-6 no-padding">
                                        	<label class="lblText"><input id="retail_status2" type="radio" name="retail_status" value="2" <?php echo ($rsData['retail_status']==2)?'checked':''; ?> class="clsAlwaysShw" /> No</label>
										</div> 
                                </fieldset>
                                <fieldset>
                                    <div class="col-sm-2 pull-left">
                                    ...
                                    <div class="col-sm-4 pull-left no-padding">
                                        <textarea class="form-control clsAlwaysShw" id="remark_desc" name="remark_desc" style="height:75px;"><?php echo $rsData['remark_desc'];?></textarea>
                                    </div>
