...
$.fn.Monthpicker = function(args, extraArgs) {
	...
	$(this).each(function(i, item) {
		switch (mode) {
			case "ctor": 
				if ((item.tagName.toLowerCase() === "input" && item.type && item.type.toLowerCase() === "text" ) || (item.tagName.toLowerCase() === "span")) {
					...
					// add UI Elements
					monthpicker.append(
						"<a class='month-icon' style='Cursor:pointer;' title='Click here to select Month/Year' ><i class='fa fa-th'></i></a><div type='text' class='monthpicker_input' style='display: none'></div>"
						+ "<div class='monthpicker_selector' style='display:none; z-index: 100;'><table><tr><td><span class='yearSwitch down'>&lt;</span></td><td><input class='yearValue clsChangeYearVal' type='text' placeholder='Year'></td><td><span class='yearSwitch up'>&gt;</span></td></tr></table></div>");
					reinit(monthpicker);
